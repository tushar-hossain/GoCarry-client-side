...
function Coverage() {
  ...
  return (
    <section className="w-full bg-[#eef0f1] px-3 py-8 sm:px-5 sm:py-10 lg:px-6 lg:py-12">
      <div className="mx-auto w-full max-w-[1100px] rounded-[14px] bg-white px-5 py-8 sm:px-8 sm:py-10 lg:px-[52px] lg:py-[38px]">
        <div>
